          ...
          <Dashboard>
            <DashboardLeftSideBar>
              ...
              <UsersIndex
                ...
                setCurrentDisplayExercises={setCurrentDisplayExercises}
              />
            </DashboardLeftSideBar>
            ...
            <DashboardCenter>
              <OrangeButton
                ...
                onClick={() =>
                  setCurrentDisplayExercises(!currentDisplayExercises)
                }
              >
                {currentDisplayExercises
                  ? "Display Submissions"
                  : "Display Exercises"}
              </OrangeButton>
              {currentDisplayExercises ? (
                ...
                <AllUserSubmissions selectedUser={selectedUser} />
              )}
            </DashboardCenter>

            <DashboardRightSideBar>{AdminInfo()}</DashboardRightSideBar>
          </Dashboard>

          <Modal show={imageShow} onHide={handleImageHide}>
            <Modal.Header closeButton>
              <Modal.Title>
                Edit Profile Photo: Drag or drop a photo here
              </Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <AdminUpdateImage
                handleImageHide={handleImageHide}
